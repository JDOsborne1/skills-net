...
test_data %>% 
  rbind(newRootSkill("Acquiring_data")) %>% 
  rbind(newRootSkill("Understanding_customer_needs")) %>% 
  rbind(newRootSkill("Working_with_credibility")) %>% 
  rbind(newRootSkill("Delivery_at_pace")) %>% 
  rbind(newRootSkill("Presenting_and_disseminating_data_effectively")) %>% 
  rbind(newRootSkill("Leadership")) -> 
    test_data
